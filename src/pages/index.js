    ...
    <div >
        ...
        <PageTemplate sidebar={false} width="800px">
            ...
            <SkillBlock title="Abstract Thinking">
                Abstract Thinking: I can visualize how all the systems will interact with each other, and what each parts role will be.
            </SkillBlock>
            <SkillBlock title="Team Player">
                Always glad to receive criticism, I accept that there can always be improvement.
            </SkillBlock>
            <p css={{fontSize:`16`}}><u>Technical Skills:</u> Many popular languages: Javascript, Node, HTML, CSS, Python, Go, C#, C++, Java. Frameworks such as Express, Flask, React,
                Bootstrap; Paradigms and Methodologies: CSS in JS, RESTful APIs, MVC, JWT, OAuth; Databases and In-Memory Database: Mongodb, DynamoDB, SQLite, MariaDB, Redis; Web Technologies such as Web Sockets, Location, Notifications;
